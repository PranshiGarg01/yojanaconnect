...
ROOT_URLCONF = 'yojanaconnect.urls'
...
WSGI_APPLICATION = 'yojanaconnect.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'yojanaconnect_db'),
...
# data.gov.in's own published public sample key (rate-limited to 10 records).
# Generate your own free key at data.gov.in for the final submission demo.
